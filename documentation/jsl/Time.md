...
<p>The node <b>operation</b> sets the operation to be call when the timeout is called. If the node <b>operation</b> is not defined the default value is <b>timeout</b> that needs to be defined and implemented in your microservice</p>
<p>
</p></span>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODI1NTEyMTMsLTEwODk5NjQxMDMsLT
