...
<span class="opdoc"><p>It set a programmable timeout that allows to call a specific operation when a timeout is triggered</p></span>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzA4NDM4NjU5LC00ODkzNDk0NTYsLTEwOD
