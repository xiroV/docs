...
<p>The node operation sets the operation to be call when the timeout is called. If the node <b>operation</b> is not defined the default value is <b>timeout</b> that needs to be defined and implemented in your microservice</p></span>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNzAyNzEzMTcsLTEwODk5NjQxMDMsLT
...
MzU5OTk4NSwtNTkzODc0OTMyLC0yMDc3MzE4NzU3LDc1MTY5NT
AzNF19
-->